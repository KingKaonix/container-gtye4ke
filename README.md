...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gtye4ke.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gtye4ke.containers.anotherwebservice.com/
...
```
git clone git@github.com:KingKaonix/container-gtye4ke.git
cd container-gtye4ke
```
...
```
docker attach container-gtye4ke
```
